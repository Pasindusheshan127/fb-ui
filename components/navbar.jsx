  ...
  return (
     <div className="py-2 px-4 bg-white shadow-md flex justify-between items-center top-0 sticky z-50">
       <div className="flex items-center gap-2">
        <FaFacebook className="text-primary text-[40px] text-sky-600"/>
        <div className="relative hidden sm:block">
          <CiSearch className="absolute text-[20px] top-[10px] left-[10px] text-gray-500"/>
          <input className="bg-gray-100 p-2 rounded-full pl-9 outline-none placeholder:text-gray-500" type="text" placeholder="search facebook" />
        </div>
      </div>
